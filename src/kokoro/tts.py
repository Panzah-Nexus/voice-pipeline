...
class KokoroTTSService(TTSService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if use_cuda:
            logger.info("Using CUDAExecutionProvider for Kokoro TTS.")
            provider_options = [
                (
            ...
            logger.info("Using CPUExecutionProvider for Kokoro TTS.")
            provider_options = ["CPUExecutionProvider"]

        self._kokoro = Kokoro(model_path, voices_path, providers=provider_options)
